...
const MyInfo={
  ...
  dob:"26-9-2000" ,
  favoritefood:
  ["banana","mango","noodles"], 
  favoritemovie:
  ["Oppenheimer","Interstellar","Amadeus", "Star","Missions"]};
console.log(MyInfo);
...
*/
const firstNames = persons.map(function getName(obj) {
...
*/
const olderPerson = persons.reduce(function (old, currently) {
  if (old.age < currently.age) {
    return currently;
  } else {
    return old;
  }
});
console.log(olderPerson.name.first + " " + olderPerson.name.last);
