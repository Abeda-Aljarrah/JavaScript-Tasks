...
arr=[2, 5, 100];
const double = arr.map(function doubleNumbers(arr){
  return arr * 2
});
console.log(double);
 ...
 * ["2", "5", "100"]
*/
const numString= arr.map(function stringItUp(arr){
  return arr.toString();
  // your code here
});
...
const capitalize= string.map(function capitalizeNames(name) {
...
const toString = Name.map(function namesOnly(name) {
  return name.name;
}); 
